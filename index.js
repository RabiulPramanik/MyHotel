        ...
        <div class="flip-card">
              <div class="flip-card-inner">
                  ...
                  <div onclick="storeLocationInfo(${location.id}, '${location.location}')" class="flip-card-back">
                      <p>${location.descriptions.slice(0, 100)}...
                      <br>
                      <button onclick="storeLocationInfo(${location.id}, '${location.location}')" class="details-button">Details</button></p>
                  </div>
              </div>
        </div>
    `
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <p>${hotel.descriptions.slice(0, 100)}...
                    <br>
                    <button onclick="storeHotelInfo(${hotel.id})" class="details-button">Details</button></p>
                </div>
            </div>
        </div>
    `
