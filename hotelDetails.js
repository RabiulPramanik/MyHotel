    ...
    .then((data) =>{
        ...
        div2.innerHTML = `
            ...
            <p>
                ...
                <br>
                <span class="map-icon">
                    <a style="color: rgb(0, 17, 254);" href="https://maps.google.com?q=${data.main_location.location}+${data.sub_location}" target="_blank"><i class="bi bi-geo-alt"></i></a> <!-- Bootstrap map icon -->
                </span>
                <a style="color: black;" href="https://maps.google.com?q=${data.main_location.location}+${data.sub_location}" target="_blank">View on Map</a>
            </p>
